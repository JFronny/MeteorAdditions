...
import dev.jfronny.meteoradditions.util.IServerFinderDoneListener;
import dev.jfronny.meteoradditions.util.MServerData;
import dev.jfronny.meteoradditions.util.ServerPinger;
...
public class ServerFinderScreen extends WindowScreen implements IServerFinderDoneListener {
    ...
    public ServerFinderScreen(GuiTheme theme, JoinMultiplayerScreen multiplayerScreen, Screen parent) {
        ...
        versionBox = theme.textBox("26.1; 1.21; 1.20; 1.19; 1.18; 1.17; 1.16; 1.15; 1.14; 1.13; 1.12; 1.11; 1.10; 1.9; 1.8");
    ...
    private boolean filterPass(MServerData info) {
        if (info == null)
            return false;
