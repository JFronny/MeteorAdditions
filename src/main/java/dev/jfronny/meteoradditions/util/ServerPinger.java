...
import dev.jfronny.meteoradditions.gui.servers.ServerFinderScreen;
...
public class ServerPinger implements IServerFinderDoneListener, IServerFinderDisconnectListener {
    ...
    public MServerData getServerInfo() {
        return server;
    }
    ...
    public void ping(String ip, int port) {
        ...
        pingIP = ip;
        pingPort = port;
        server = new MServerData("", ip + ":" + port);
        server.version = null;
